...
vCodePen.install = function install(Vue) {
  ...
  let _codepen_embed_method = function() {
    function e() {
      function e() {
        for (
          var e = document.getElementsByClassName("codepen"), t = e.length - 1;
          t > -1;
          t--
        ) {
          var u = a(e[t]);
